...
| K3-X | [Finite executable kernel and coding-plugin spike](K3_X_finite_executable_spike.md) | Handoff `CONSUMED`; [repair 12 rejected](../../docs/reviews/kernel_plugin/K3_X_Implementation_720d45f_review.md); six-path repair only, no execution authority |
