...
| K3-X | [Finite executable kernel and coding-plugin spike](K3_X_finite_executable_spike.md) | `READY_TO_BIND`; [handoff accepted](../../docs/reviews/kernel_plugin/K3_X_Handoff_e9c23b7_review.md); no mutation or execution authority before exact dispatch |
