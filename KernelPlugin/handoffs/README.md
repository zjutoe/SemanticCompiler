...
| K3-X | [Finite executable kernel and coding-plugin spike](K3_X_finite_executable_spike.md) | Handoff `CONSUMED`; [implementation accepted](../../docs/reviews/kernel_plugin/K3_X_Implementation_326a57f_review.md); accepted binding was strengthened for executable dispatch and the updated [binding](K3_X_execution_binding.md) and [amendment](K3_X_execution_command_amendment.md) require re-review; no execution authority |
