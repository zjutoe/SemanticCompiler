...
| K3-X | [Finite executable kernel and coding-plugin spike](K3_X_finite_executable_spike.md) | Handoff `CONSUMED`; [implementation accepted](../../docs/reviews/kernel_plugin/K3_X_Implementation_326a57f_review.md); [execution binding](K3_X_execution_binding.md) and [command-isolation amendment](K3_X_execution_command_amendment.md) [accepted](../../docs/reviews/kernel_plugin/K3_X_Execution_Binding_d3436f3_review.md); awaiting exact main dispatch and result review |
