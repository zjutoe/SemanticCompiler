...
| K3-X | [Finite executable kernel and coding-plugin spike](K3_X_finite_executable_spike.md) | Handoff `CONSUMED`; [repair 5 rejected](../../docs/reviews/kernel_plugin/K3_X_Implementation_f8ef2dd_review.md); six-path repair only, no execution authority |
