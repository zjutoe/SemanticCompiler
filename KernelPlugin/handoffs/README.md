...
| K3-X | [Finite executable kernel and coding-plugin spike](K3_X_finite_executable_spike.md) | Candidate; no mutation or execution authority pending independent review |
