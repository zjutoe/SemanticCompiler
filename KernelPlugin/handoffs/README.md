...
| K3-X | [Finite executable kernel and coding-plugin spike](K3_X_finite_executable_spike.md) | `ACCEPTED`; [implementation](../../docs/reviews/kernel_plugin/K3_X_Implementation_326a57f_review.md), [execution binding](../../docs/reviews/kernel_plugin/K3_X_Execution_Binding_e405474_review.md), and [final result](../../docs/reviews/kernel_plugin/K3_X_Executable_Result_68927ab_review.md) accepted; [report](../../docs/reports/kernel_plugin/K3_X_Executable_Spike_Report.md) |
