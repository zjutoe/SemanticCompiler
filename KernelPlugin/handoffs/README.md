...
| K1 | [Minimal kernel calculus and denotational semantics](K1_kernel_calculus_and_semantics.md) | `ACCEPTED`; [exact review](../../docs/reviews/kernel_plugin/K1_Handoff_dd87c79_review.md), held-out gate pending, not dispatched |
