...
| K3-X | [Finite executable kernel and coding-plugin spike](K3_X_finite_executable_spike.md) | Handoff `CONSUMED`; [repair 8 rejected](../../docs/reviews/kernel_plugin/K3_X_Implementation_40447ee_review.md); six-path repair only, no execution authority |
