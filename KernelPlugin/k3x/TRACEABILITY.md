...
|---:|---|---|---|---|---|
| 1 | `admit_typed_value`, `admitted_closed_value`, `compose_records`, `validate_packages`, `_validate_retained_ck_exact`, `required_subject`, `reasoning_target_roots`, `validate_profile_binding`, `evaluate_invocation`, `observe`, `verification_passed`, `task_accepts` | one literal `PKG_CK`: exact 55 `DELTA_TYPE_X`, 47 `DELTA_LITERAL_X`, 17 `DELTA_SYMBOL_X`, ordinary/pair/profile Sigma records, all model contracts, six field-complete capabilities, exact `BENV/BCERT`, and field-sensitive admission relations; bounds/confluence/lexical descriptors carry exact typed Contract/Formula subjects | `test_k3x_01_core_definitional_and_closed_coding_values`; independently freezes target roots, rejects bare strings, a substituted non-semantic carrier, and a lexical target with one typed subject omitted, and retains all Repair-10 field/admission falsifiers | K1 §§2.1–2.3; K2 §§2.4, 3.2–3.3, 4.1–4.3, 5.1–5.2; K3-S §§2.1–2.2, 3.2, 4.1, 6.2, 8.2, 9.1, 9.6 check 1 | exact `TRUE`; descriptor proper roots are the union of `required` for every exact typed subject, the semantic-environment carrier, and exact service/fragment/trust roots; omission or carrier substitution is malformed |
