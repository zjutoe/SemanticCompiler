...
> Status: K0 is accepted and complete; the exact K1 handoff and held-out pre-dispatch gate are accepted. K1 is `READY_TO_BIND`, not dispatched.
...
| K1 | Kernel calculus and denotational semantics | Handoff and held-out gate accepted; `READY_TO_BIND`, not dispatched |
