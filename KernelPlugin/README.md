...
> Status: K0 through K3-S and K3-X are accepted and complete. K4 remains roadmap-only and has no handoff or execution authority.
...
| K3-X | Finite in-memory toy kernel and accepted toy coding plugin | Accepted and complete; [final executable report](../docs/reports/kernel_plugin/K3_X_Executable_Spike_Report.md) |
| K4 | Held-out semantic closure and manual binding assessment | Roadmap only; no handoff or authority |
