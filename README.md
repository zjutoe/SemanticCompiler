...
- [`docs/reviews/`](docs/reviews/README.md) contains the current plan and K0 handoff acceptance records plus historical advisory review input.

No implementation stage is currently authorized. The [K0 handoff](KernelPlugin/handoffs/K0_scope_status_and_challenges.md) passed [independent review](docs/reviews/kernel_plugin/K0_Handoff_59d2799_review.md) and is `READY_TO_BIND`; it has not been bound or dispatched and grants no mutation authority by itself.
