...
- [`docs/reviews/`](docs/reviews/README.md) contains the current plan, K0 handoff, and K0 deliverable acceptance records plus historical advisory review input.

K0 is complete. Its [semantic design inputs](KernelPlugin/K0_Semantic_Design_Inputs_v0.md) passed [independent review](docs/reviews/kernel_plugin/K0_Design_Inputs_6ad555e_review.md) for exact blob `e86e184300a6620fb6fe25062635d9bc7cb410a1`. No implementation stage is authorized. A [K1 handoff candidate](KernelPlugin/handoffs/K1_kernel_calculus_and_semantics.md) now exists for independent review; it grants no mutation or dispatch authority.
